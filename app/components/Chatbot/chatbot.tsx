...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      />
      {showchat && (
        <div className="fixed right-[calc(2rem)] border-t-2 border-orange-500 rounded-lg hover:cursor-pointer p-5 shadow-lg  border  shadow-orange transition ease-out h-[600px] w-[300px] md:w-[500px] bottom-[calc(6rem)]">
          <div className="flex flex-col h-full">
            <div className="border-b-2 border rounded-lg border-b-black shadow-black shadow-sm  p-2">
              ...
              <p className="text-xs">
                Ask your doubts and queries regarding our shipping platform ,
